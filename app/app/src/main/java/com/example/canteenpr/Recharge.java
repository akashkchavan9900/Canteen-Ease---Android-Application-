...
public class Recharge extends AppCompatActivity implements PaymentStatusListener {
      ...
      /*  bt_done=(Button)findViewById(R.id.done);
        ...
        bt_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Recharge.this, "Recharge Sucssesfully", Toast.LENGTH_SHORT).show();
            }
        });*/
    ...
    private void initViews() {
        ...
        fieldAmount.setText(fieldAmount.getText().toString()+".00");
    }
    private void pay() {
